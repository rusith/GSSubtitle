...
namespace GSSubtitle.Controllers.UnReDoPattern
{
    ...
    public static class URD
    {
        ...
        private static DOStack<Change> _UndoStack = new DOStack<Change>(Settings.MaxUndoAndRedos);
        private static DOStack<Change> _RedoStack = new DOStack<Change>(Settings.MaxUndoAndRedos);
